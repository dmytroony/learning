...
_If you need this for Electron, check out [`electron-store`](https://github.com/sindresorhus/electron-store) instead._<br>
_And check out [`conf`](https://github.com/sindresorhus/conf) for an updated approach to this concept._
