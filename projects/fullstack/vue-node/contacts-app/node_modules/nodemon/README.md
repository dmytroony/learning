...
If no script is given, nodemon will test for a `package.json` file and if found, will run the file associated with the _main_ property ([ref](https://github.com/remy/nodemon/issues/14)).
