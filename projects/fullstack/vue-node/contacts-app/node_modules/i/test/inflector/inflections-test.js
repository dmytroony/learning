    ...
    .addBatch({
      "Test inflector inflections": {
        ...
        human: function(topic) {
          ...
          return assert.deepEqual(topic.humans, [
        ...
        plural: function(topic) {
          ...
          assert.deepEqual(topic.plurals, [
            ["money", "monies"],
            ["ox", "oxen"]
          ]);
        ...
        singular: function(topic) {
          ...
          assert.deepEqual(topic.singulars, [
            ["money", "monies"],
            ["ox", "oxen"]
          ]);
          return assert.isEmpty(topic.uncountables);
