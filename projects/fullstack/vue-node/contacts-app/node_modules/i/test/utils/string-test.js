(function() {
  ...
  vows
    .describe("Module core extension String")
    .addBatch({
      "Testing value": {
        topic: "bullet",
      ...
      "Testing gsub": {
        ...
        "when replacement is special": {
          "with many groups": function(topic) {
            return assert.equal(
              util.string.gsub(topic, /([aeiou])(.)/, "<$1>$2"),
              "b<u>ll<e>t"
            );
          },
          "with no groups": function(topic) {
            return assert.equal(
              util.string.gsub(topic, /[aeiou]/, "<$1>"),
              "b<u>ll<e>t"
            );
          }
        }
      ...
      "Testing upcase": {
        ...
        "letter after underscore": function(topic) {
          return assert.equal(
            util.string.upcase("bullet_record"),
            "Bullet_Record"
          );
        },
        "letter after slash": function(topic) {
          return assert.equal(
            util.string.upcase("bullet_record/errors"),
            "Bullet_Record/Errors"
          );
        },
        "no letter after space": function(topic) {
          return assert.equal(
            util.string.upcase("employee salary"),
            "Employee salary"
          );
        }
      },
      "Testing downcase": {
        ...
        "letter after underscore": function(topic) {
          return assert.equal(
            util.string.downcase("BULLET_RECORD"),
            "bULLET_rECORD"
          );
        },
        "letter after slash": function(topic) {
          return assert.equal(
            util.string.downcase("BULLET_RECORD/ERRORS"),
            "bULLET_rECORD/eRRORS"
          );
        }
      }
