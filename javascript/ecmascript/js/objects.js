...
// let fruit = prompt('Which fruit should you buy?', 'apple');
//
// // let bag = {
// //   [fruit]: 5,
// // };
...
// console.log('programmer' in user);
...
//     console.log(`${codesKey}: ${codes[codesKey]}`);
// }
...
// };
//
// // for (let codesKey in codes2) {
// //     console.log(`${codesKey}: ${codes2[codesKey]}`);
// // }
//
// // console.log(codes2['+49']);
// // console.log('key' in codes2);
//
// console.log(codes2);
// console.log(codes2.key);
//
// delete codes2.key;
//
// console.log(codes2);
// console.log(codes2.length)
...
// let userName = prompt('Who\'s there? Enter your name...', '');
//
// if (userName === 'admin') {
//
//     let userPassword = prompt('Enter your password here...', '');
//
//     if (userPassword === 'general') {
//         console.log(`Hello, ${userName}!`);
//     } else if (userPassword === null) {
//         console.log('cancelled');
//     } else if (userPassword !== 'general' || userPassword === '') {
